package com.joker.module.common.qrcode.util;

/**
 * Created by zhangjian on 2016/8/26.
 */
...
public class QrcodeUtils {
    ...
    public static final void gen(final String content,
        ...
        final MatrixToLogoImageConfig logoConfig = new MatrixToLogoImageConfig(Color.WHITE, 6);
...
class MatrixToLogoImageConfig {
    ...
    public static final int DEFAULT_LOGOPART = 10;
